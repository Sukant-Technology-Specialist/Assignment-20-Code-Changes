var TictactoeDemo = /** @class */ (function () {
    function TictactoeDemo() {
    }
    TictactoeDemo.prototype.displayTable = function () {
        ...
        if (this.turn == "X" || this.turn == "O") {
            ...
            document.body.innerHTML += "<p class='enter'> Please select atleast one player X (or) O </p>";
            document.body.innerHTML += "<p><button class='enter_button' onclick=tic.reload()>Reload</button></p>";
        }
    };
    TictactoeDemo.prototype.inputClick = function (id) {
    ...
    TictactoeDemo.prototype.check_X = function () {
        for (var i = 0; i < this.winner.length; i++) {
            var move = this.winner[i][0].toString();
            var move1 = this.winner[i][1].toString();
            var move2 = this.winner[i][2].toString();
            var opt = false;
            var opt1 = false;
            var opt2 = false;
    ...
    TictactoeDemo.prototype.check_Y = function () {
        for (var i = 0; i < this.winner.length; i++) {
            var move = this.winner[i][0].toString();
            var move1 = this.winner[i][1].toString();
            var move2 = this.winner[i][2].toString();
    ...
    TictactoeDemo.prototype.completed = function (winner) {
        ...
        if (winner == "Tie") {
            ...
            p1.innerHTML = "&nbsp;&nbsp;&nbsp;&nbsp;Hard Luck, " + winner;
            p1.setAttribute("class", "p1");
            p1.innerHTML += "<svg width=\"1em\" height=\"1em\" viewBox=\"0 0 16 16\" fill=\"currentColor\" xmlns=\"http://www.w3.org/2000/svg\">\n            <path fill-rule=\"evenodd\" d=\"M8 15A7 7 0 1 0 8 1a7 7 0 0 0 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z\"/>\n            <path fill-rule=\"evenodd\" d=\"M4 10.5a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5z\"/>\n            <path d=\"M7 6.5C7 7.328 6.552 8 6 8s-1-.672-1-1.5S5.448 5 6 5s1 .672 1 1.5zm4 0c0 .828-.448 1.5-1 1.5s-1-.672-1-1.5S9.448 5 10 5s1 .672 1 1.5z\"/>\n          </svg>";
            p1.innerHTML += "<button class='res_button1' onclick=tic.reload()>Restart</button>";
            ...
            p2.innerHTML += "<svg width=\"1em\" height=\"1em\" viewBox=\"0 0 16 16\"  fill=\"currentColor\" xmlns=\"http://www.w3.org/2000/svg\">\n            <path fill-rule=\"evenodd\" d=\"M8 15A7 7 0 1 0 8 1a7 7 0 0 0 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z\"/>\n            <path fill-rule=\"evenodd\" d=\"M4.285 9.567a.5.5 0 0 1 .683.183A3.498 3.498 0 0 0 8 11.5a3.498 3.498 0 0 0 3.032-1.75.5.5 0 1 1 .866.5A4.498 4.498 0 0 1 8 12.5a4.498 4.498 0 0 1-3.898-2.25.5.5 0 0 1 .183-.683z\"/>\n            <path d=\"M7 6.5C7 7.328 6.552 8 6 8s-1-.672-1-1.5S5.448 5 6 5s1 .672 1 1.5zm4 0c0 .828-.448 1.5-1 1.5s-1-.672-1-1.5S9.448 5 10 5s1 .672 1 1.5z\"/>\n            </svg>";
            p2.innerHTML += "<button class='res_button1' onclick=tic.reload()>Restart</button>";
            p2.setAttribute("class", "p1");
            division.appendChild(p2);
            this.main_div.appendChild(division);
        }
    };
    TictactoeDemo.prototype.reload = function () {
        location.reload();
    };
    return TictactoeDemo;
}());
var tic = new TictactoeDemo();
tic.main_div = document.getElementById("div");
tic.child_div = document.createElement("div");
tic.child_div.innerHTML = "<span class='span'>which payer you want : player X (or) O:</span>";
tic.child_div.innerHTML += "<input type=text id='player' class='inp'>";
tic.child_div.innerHTML += "<br><br><button onclick=\"tic.displayTable()\" class='start'>Play</button>";
