class TictactoeDemo
{
    ...
    displayTable()
    {
        ...
        let position =<HTMLDivElement>document.getElementById("position1");
    ...
    check_X():boolean {
        for (let i = 0; i < this.winner.length; i++) {
            let move = this.winner[i][0].toString();
            let move1 = this.winner[i][1].toString();
            let move2 = this.winner[i][2].toString();
